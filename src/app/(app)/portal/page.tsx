    ...
    return (
      <div className="p-6 lg:p-8 max-w-3xl mx-auto w-full">
        ...
        <div className="rounded-[18px] border border-amber-200 bg-amber-50 p-6 text-center">
          ...
          <h2 className="text-lg font-semibold text-amber-900 mb-1">Account not linked</h2>
          <p className="text-sm text-amber-700 max-w-sm mx-auto">
            Your account has not been linked to an employee record yet. Please ask your HR admin to link your profile.
          </p>
        </div>
      </div>
    );
