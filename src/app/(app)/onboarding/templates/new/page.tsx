...
export const metadata: Metadata = { title: "New Onboarding Template" };
      ...
      <div className="relative overflow-hidden rounded-[24px] bg-linear-to-br from-navy-950 via-navy-900 to-navy-800 px-7 py-6 mb-8 shadow-xl">
        ...
        <div className="relative">
          <div className="flex items-center gap-2 text-blue-400 text-xs mb-2">
            ...
            <Link href="/onboarding/templates" className="hover:text-white transition-colors">Templates</Link>
            <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
            </svg>
            <span className="text-blue-300">New template</span>
          </div>
          <h1 className="text-2xl font-bold text-white tracking-tight">New template</h1>
          <p className="text-blue-300 text-sm mt-1">Define a reusable checklist for onboarding or offboarding.</p>
        </div>
      </div>
      <NewTemplateForm />
    </div>
