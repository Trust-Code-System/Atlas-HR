...
export default async function NewPayrollRunPage() {
  ...
  if (!orgCtx.isAdmin) redirect("/payroll");
      ...
      <div className="relative overflow-hidden rounded-[24px] bg-linear-to-br from-navy-950 via-navy-900 to-navy-800 px-7 py-6 mb-8 shadow-xl">
        ...
        <div className="relative">
          <div className="flex items-center gap-2 text-blue-400 text-xs mb-2">
            ...
            <span className="text-blue-300">New payroll run</span>
          </div>
          <h1 className="text-2xl font-bold text-white tracking-tight">New payroll run</h1>
          <p className="text-blue-300 text-sm mt-1">Employee salaries will be auto-populated from the People directory.</p>
        </div>
      </div>
      <NewPayrollRunForm />
    </div>
