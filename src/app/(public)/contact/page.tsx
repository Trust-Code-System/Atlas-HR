...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the Atlas HR team. Email us at hello@atlashr.xyz for sales, support, partnerships, or general questions.",
};

const CONTACT_EMAIL = "hello@atlashr.xyz";
